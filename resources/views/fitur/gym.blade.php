<x-app-layout>
    ...
    <div class="unified-gradient min-h-screen">
        <!-- Hero Section -->
        <section class="pt-32 pb-20" aria-labelledby="hero-title">
            <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                <div class="text-left mb-12">
                    <h1 id="hero-title" class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 mb-4">GYM</h1>
                    <p class="text-lg lg:text-xl text-gray-700">Finding GYM location nearby you</p>
                </div>
            </div>
        </section>
        ...
        <main class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="gym-listings">
                @foreach ($gymTotal as $index => $gym)
                    <article
                        class="gym-item bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 {{ $index >= 6 ? 'hidden' : '' }}"
                        ...
                        <a href="{{ route('gym.detail', $gym->id_gym) }}" class="block">
                            ...
                            <header class="p-6 border-b border-gray-100">
                                <h2 id="gym-name-{{ $gym->id_gym }}" class="text-xl font-bold text-gray-900 mb-2">
                                    {{ $gym->nama }}</h2>
                            ...
                            <div class="aspect-w-16 aspect-h-9">
                                <img src="{{ asset($gym->image) }}" alt="{{ $gym->nama }} gym interior"
                                    class="w-full h-48 object-cover" loading="{{ $index < 3 ? 'eager' : 'lazy' }}">
                            </div>
                            ...
                            <div class="p-6">
                                ...
                                <section class="mb-6" aria-labelledby="services-{{ $gym->id_gym }}">
                                    <div class="flex justify-between items-center mb-4">
                                        <h3 id="services-{{ $gym->id_gym }}" class="text-lg font-bold text-gray-900">
                                            Services</h3>
                                        <span class="text-sm text-gray-500 hover:text-gray-700 cursor-pointer">View
                                            all</span>
                                    </div>
                                    ...
                                    @else
                                        ...
                                        <div class="grid grid-cols-3 gap-4">
                                            <div class="text-center">
                                                <div
                                                    class="w-16 h-16 mx-auto mb-3 rounded-full bg-gradient-to-br from-red-100 to-red-200 flex items-center justify-center shadow-md">
                                                ...
                                                <h4 class="text-sm font-semibold text-gray-900 mb-1">Weight Training
                                                </h4>
                                                <p class="text-xs text-gray-600">Complete weight training equipment</p>
                                            </div>
                                            <div class="text-center">
                                                <div
                                                    class="w-16 h-16 mx-auto mb-3 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center shadow-md">
                                                    <svg class="w-6 h-6 text-blue-600" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="text-center">
                                                ...
                                                <h4 class="text-sm font-semibold text-gray-900 mb-1">Personal Trainer
                                                </h4>
                                    ...
                                    <div class="flex items-center justify-center">
                                        @if ($gym->is_open)
                                            <div class="flex items-center text-green-600">
                                                ...
                                                <span
                                                    class="text-sm font-medium">{{ $gym->open_status_with_time }}</span>
                                            </div>
                                        @else
