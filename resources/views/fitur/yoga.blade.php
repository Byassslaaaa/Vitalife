    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div id="yoga-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($yogaTotal as $index => $yoga)
                <div class="yoga-item bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 {{ $index >= 6 ? 'hidden' : '' }}">
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-3 gap-4 mb-6">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Stimulate foot reflex points to boost health</p>
                                </div>
                                <div class="text-center">
                            ...
                            <div class="space-y-3 mb-6">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-lg font-bold text-blue-600">Rp {{ number_format($yoga->harga, 0, ',', '.') }}</span>
                                </div>
                                @if(isset($yoga->class_type))
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm text-gray-600">Class Type:</span>
                                        <span class="text-sm font-medium text-gray-900 capitalize">{{ $yoga->class_type }}</span>
                                    </div>
                                @endif
                            </div>
        ...
        <div class="text-center mt-12">
            <button id="loadMoreBtn" class="bg-gray-800 hover:bg-gray-900 text-white font-medium py-3 px-8 rounded-lg transition duration-300">
                Load More
            </button>
        </div>
        @endif
