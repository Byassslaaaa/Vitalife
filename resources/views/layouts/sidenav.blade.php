    ...
    < <!-- Event -->"py-6 px-4 sticky top-0 bg-black z-10">
        ...
        <div class="flex-grow overflow-y-auto py-4 px-4 scrollbar-hide">
            <nav class="space-y-2">
                ...
                <!-- Bookings -->
                <a href="{{ route('admin.spa-bookings.index') }}"
                    class="p-3 rounded-lg flex items-center {{ Request::routeIs('admin.spa-bookings.*') || Request::routeIs('admin.yoga-bookings.*') || Request::routeIs('admin.gym-bookings.*') ? 'bg-white text-black' : 'text-white hover:bg-gray-700' }} transition-colors duration-200">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Spa Analytics -->
                <a href="{{ route('admin.spa-analytics.index') }}"
                    class="p-3 rounded-lg flex items-center {{ Request::routeIs('admin.spa-analytics.*') ? 'bg-white text-black' : 'text-white hover:bg-gray-700' }} transition-colors duration-200">
                    <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/>
                    </svg>
                    <span class="text-sm font-medium">Spa Analytics</span>
                </a>
            </nav>
        </div>
