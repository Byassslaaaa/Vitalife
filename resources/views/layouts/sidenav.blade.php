<aside class="aside bg-black w-48 min-h-screen fixed left-0 top-0 flex flex-col">
    <!-- Fixed logo section -->
    <div class="py-6 px-4 sticky top-0 bg-black z-10">
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="w-8 h-8 rounded-full border-2 border-emerald-400 flex items-center justify-center">
                    <svg class="w-5 h-5 text-emerald-400" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.19 0 2.34-.21 3.41-.6.3-.11.49-.4.49-.72 0-.43-.35-.78-.78-.78-.25 0-.47.12-.61.3-.85.29-1.76.44-2.71.44-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8c0 .95-.15 1.86-.44 2.71-.18.14-.3.36-.3.61 0 .43.35.78.78.78.32 0 .61-.19.72-.49.39-1.07.6-2.22.6-3.41C22 6.48 17.52 2 12 2z"/>
                        <path d="M12 6c-3.31 0-6 2.69-6 6 0 1.66.67 3.16 1.76 4.24l1.41-1.41C8.67 14.33 8.2 13.2 8.2 12c0-2.1 1.7-3.8 3.8-3.8s3.8 1.7 3.8 3.8c0 1.2-.47 2.33-.97 2.83l1.41 1.41C17.33 15.16 18 13.66 18 12c0-3.31-2.69-6-6-6z"/>
    ...
    <div class="flex-grow overflow-y-auto py-4 px-4 scrollbar-hide">
        <nav class="space-y-2">
            ...
            <a href="{{ route('admin.spesialisis.index') }}"
                class="p-3 rounded-lg flex items-center {{ Request::routeIs('admin.spesialisis.*') ? 'bg-white text-black' : 'text-white hover:bg-gray-700' }} transition-colors duration-200">
                <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z"/>
                </svg>
                <span class="text-sm font-medium">Spesialis</span>
            </a>
            ...
            <a href="{{ route('admin.chat') }}"
                ...
                <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M3 6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-6.616l-2.88 2.592C8.537 20.461 7 19.776 7 18.477V17H5a2 2 0 0 1-2-2V6Z" />
                </svg>
            ...
            <a href="{{ route('admin.vouchers.index') }}"
                ...
                <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 10V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v4c1.1 0 2 .9 2 2s-.9 2-2 2v4c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-4c-1.1 0-2-.9-2-2s.9-2 2-2zm-9 7.5c-2.5 0-4.5-2-4.5-4.5s2-4.5 4.5-4.5 4.5 2 4.5 4.5-2 4.5-4.5 4.5zM13 12c0-.6-.4-1-1-1s-1 .4-1 1 .4 1 1 1 1-.4 1-1z"/>
                </svg>
